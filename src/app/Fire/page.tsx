...
const Fire = () => {
  ...
  return (
    <section
      className={`flex items-center px-10 flex-col overflow-hidden   ${theme.background} ${theme.text}`}
    >
      <div className="mt-36">
        <div className=" flex flex-col items-center">
          ...
          <p className="w-[800px]  max-lg:w-[400px]  text-center mt-5 max-sm:text-lg ">
            Discover the elite of the modeling world. Our curated list of the
            Top 30 Models showcases the most sought-after talent, celebrated for
            their exceptional skills, versatility, and captivating presence.
            From runway to editorial, these models are at the forefront of
            fashion, influencing trends and inspiring creativity.
          </p>
          <div
            // ref={imageRef}
          ...
          <p className={`w-[800px] text-center mt-5 `}>
            ...
            event, or project, our agency is here to help. We represent a
            diverse roster of experienced models who are ready to bring your
            vision to life. For inquiries, please reach out to us directly. Our
            team is dedicated to matching you with the ideal model that aligns
            with your brand's aesthetic and goals. Let’s collaborate to create
